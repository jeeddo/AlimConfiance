...
export default function FilterModalMobileDevices() {
    return ( <div className='scale-0 bg-neutral-100 md:hidden fixed bottom-0 w-full h-[85%] flex flex-col justify-start items-center gap-16 rounded-t-2xl xs:text-base text-sm'>
