...
import { MainFormProps } from "./main-form/mainForm.types.d";
...
export default function FilterModalMobileDevices({isFilterMobileActivated, setBtnState, isSearchBtnClicked, ...props} : FilterModalMobileDevicesProps) {
