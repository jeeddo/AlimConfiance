...
export default function FilterModalMobileDevices({isFilterMobileActivated, setBtnState, ...props} : Omit<FilterModalMobileDevicesPros, 'breakPoint'>) {
