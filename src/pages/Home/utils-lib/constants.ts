...
export const LOCATION_PATH =
  import.meta.env.VITE_BACKEND_LOCATION_PATH || '/api/location'

export const RESTAURANT_PATH =
  import.meta.env.VITE_BACKEND_RESTAURANT_PATH || '/api/restaurant'
...
export const HYGIENE_LEVELS: HygieneLevel[] = [
  'Tous les niveaux',
  Ratings.EXCELLENT,
  Ratings.GOOD,
  Ratings.AVERAGE,
...
export const HELP_TO_SEARCH: HelpToSearch = {
  ...
  subtitle:
    'Vous pouvez rechercher un établissement selon plusieurs critères : ',
  demo: [
